...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (studentList.isEmpty()) {
            studentList.add(Student("David Hatuka", "00001", "052-7654321", "Rishon Lezion", true, R.drawable.ic_student))
            studentList.add(Student("Shimrit Hatuka", "00002", "050-1234567", "Tel Aviv", false, R.drawable.ic_student))
            studentList.add(Student("Shontal Hizbboalaha", "00003", "052-7654344", "Jerusalem", true, R.drawable.ic_student))
            studentList.add(Student("Ahmed Ben Sahel", "00004", "054-9876555", "Haifa", false, R.drawable.ic_student))
            studentList.add(Student("Sarit El Al", "00005", "054-9876543", "Ramla", false, R.drawable.ic_student))
        }
    }
